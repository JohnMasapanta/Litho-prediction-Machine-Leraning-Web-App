...
def load_raw():
    ...
    raw_hidden = pd.read_csv("./raw_data/hidden_test.csv", sep=";")
    ...
    #test_data = pd.read_csv(main_directory + '\open_test.csv', sep=';')
    #test_labels = pd.read_csv(main_directory + '\open_target.csv', sep=';')
