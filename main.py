...
def load_raw():
    ...
    test_data = pd.read_csv(r"./raw_data/open_test.csv', sep=';')
    test_labels = pd.read_csv(r"./raw_data/open_target.csv', sep=';')
...
def pretrained_models():
    ...
    #extreme_gb = pickle.load(open(r"./models/extreme_gb.sav", 'rb'))
